...
<html lang="en">
    ...
    <body>
				...
				<div class="row">
					...
					<div class="col-lg-9" id = "logos">
						<div class="feature-wrap">
							<div class="row">
								<div class="col-md-5" id = "log-lic">
									<div class = "logos-all">										
										<img class = "img-fluid" src="assets/img/client/Logos-licens.png" alt="" style="margin-top: 16px;">
									</div>
								</div>
								<div class="col-md-1" id = "pails">
									<div style="margin-top: 23px;text-align: center;">
										<img class = "img-fluid" src="assets/img/client/pail.png" alt="">
									</div>
								</div>
								<div class="col-md-4">
									<div class="single-feature" style="text-align: left;padding-left: 33px;padding-right: inherit;">										
										<p>Métodos preventivos y correctivos que permiten el control integral de plagas</P>										
									</div>
								</div>									
								<div class="col-md-2" id = "homeprot">
									<div style="margin-top: 29px;" >
										<img class = "img-fluid" src="assets/img/client/home-protect.png" alt="">
									</div>
								</div>
							</div>
						</div>
		...
		<!-- End About Area two -->
		<!-- Start About Area two -->
		<section class="about-area-two bg-about-color pt-100 pb-100">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-6">
		...
		<section class="important-area pt-100">
		...
		<!-- End Prevent Area -->
		<!-- Start Contact Area -->
		<section class="contact-area ptb-100 bg-about-color" style="direction: initial;margin-top: 80px;">
			<div class="container">
				<div class="row">
					<div class="col-lg-8">
